...
// 页面加载时锁定当前页面对应的方块
onMounted(() => {
  activeBlock.value = 2 // 网页页锁定第二个方块
})
...
const handleRefreshExample = async () => {
  try {
    const exampleGroups: string[][] = [
      ["响应式网页设计的最佳实践", "提升网站加载速度的10个技巧", "2024年网页设计趋势", "Vue3 + TypeScript 项目搭建", "Tailwind CSS 使用技巧", "前端性能优化指南"],
      ["SEO 优化策略", "用户体验设计原则", "跨浏览器兼容性处理", "PWA 渐进式Web应用", "WebAssembly 入门", "微前端架构实践"],
      ["CSS Grid 布局详解", "JavaScript 设计模式", "Web安全最佳实践", "GraphQL vs REST", "前端自动化测试", "Webpack5 优化配置"]
    ]
